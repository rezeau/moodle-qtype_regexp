...
$string['penaltyforeachincorrecttry'] = 'Penalty for incorrect tries and Help';
...
$string['usehint'] = 'Display Help button';
$string['usehint_help'] = 'Selecting <strong>Display Help Button</strong> -&gt; <strong>Yes</strong> will display a <strong>Help me</strong> button 
to allow the student to "buy" a letter.    

By default Display Help button value is set at <b>No</b>';
?>