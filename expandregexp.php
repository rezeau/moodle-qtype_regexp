<?php  // $Id: expandregexp.php,v 1.4.2.3 2008/06/01 13:14:12 joseph_rezeau Exp $
...
//    process metacharacters not accepted in sentence generation
    ...
    if ($illegalchar == true && isteacher() ) {
        echo ('<p>'.get_string('cannotgenerateregexp', 'qtype_regexp').implode(' ', $illegalchars).'</p><p>'.
            get_string('cannotgenerateregexp2', 'qtype_regexp').'</p><p>'.
            get_string('regexperror', 'qtype_regexp', $myregexp).'</strong></p>');
        return ('$myregexp');
    }
